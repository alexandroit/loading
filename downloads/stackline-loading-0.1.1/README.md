...
5. [Built-in Variants](#built-in-variants)
6. [Smart Loading Behavior](#smart-loading-behavior)
...
- [GitHub downloads folder](https://github.com/alexandroit/loading/tree/main/downloads)
