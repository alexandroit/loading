...
loader.show();`},j=[{id:"dashboard-card",title:"Dashboard card",description:"A polished card overlay keeps the layout stable while a metric tile refreshes.",variant:"orbit",options:{variant:"orbit",size:44,overlay:!0,centered:!0,label:"Refreshing KPI"},previewHtml:`
...
`,T=[{slug:"home",title:"@revivejs/loading",eyebrow:"Premium Loading Toolkit",description:"A modern framework-agnostic loading library for overlays, buttons, cards, dashboards, and polished async UX.",body:`
  ...
  `}function F(){if(!O)return;w.forEach(r=>r()),w.clear();const e=Te($e());O.innerHTML=`
  ...
  `,window.scrollTo({top:0,behavior:"instant"}),G(),Pe(),X()}function G(){var e;document.querySelectorAll("[data-theme-toggle]").forEach(r=>{r.addEventListener("click",Ie)}),(e=document.querySelector("[data-nav-toggle]"))==null||e.addEventListener("click",()=>{document.body.classList.toggle("is-nav-open")}),document.querySelectorAll(".copy-button").forEach(r=>{r.addEventListener("click",async()=>{var t,i;const a=((i=(t=r.closest(".code-block"))==null?void 0:t.querySelector("code"))==null?void 0:i.textContent)??"";try{await navigator.clipboard.writeText(a),r.textContent="Copied",window.setTimeout(()=>{r.textContent="Copy"},1200)}catch{r.textContent="Copy failed"}})}),document.querySelectorAll(".nav-link").forEach(r=>{r.addEventListener("click",()=>{document.body.classList.remove("is-nav-open")})})}function Ue(e,r){e.innerHTML=r.map(a=>{const t=k(a);return`
      ...
      `}).join(""),e.querySelectorAll("[data-variant-host]").forEach(a=>{const t=a.dataset.variantHost,i={variant:t,size:t==="shimmer"?56:44,centered:!0,label:"",target:a,visible:!0},l=t.includes("dots")?4:t.includes("bars")?5:null,n=L(l==null?i:{...i,count:l});n.mount(a),n.show(),w.add(()=>n.destroy())})}function Ee(e){e.innerHTML=j.map(r=>`
